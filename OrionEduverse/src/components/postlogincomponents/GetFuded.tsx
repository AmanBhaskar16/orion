...
// // import { Video, Users, Lightbulb, MessageSquare } from "lucide-react"
...
// //       description: "Explore vetted accelerators,incubators and grant programs across the globe.",
...
// //       description: "Present your startup to interested investors and ecosystem partners directly.",
...
// //       description: "Make your startup journey smoother with our exclusive AI Suite toolkit.Get sector wise fundraising tools,financial models,legal docs for free!",
// //       color: "bg-purple-500/20 text-purple-400 border-purple-500/30",
// //       glowColor: "group-hover:shadow-purple-500/25",
// //     },
// //   ]
...
//   // The image and image-related state/logic are removed here.
...
//         {/* Cards Container: Changed to 2-column grid */}
//         <div className="relative grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 max-w-4xl mx-auto">
//           {sessionTypes.map((session, index) => {
//             const IconComponent = session.icon
//             return (
//               <Card
...
//               >
//                 <CardContent className="p-6 flex items-start space-x-4">
//                   {/* Icon Styling Enhancement: Solid background, subtle glow on hover */}
//                   <div className={`
