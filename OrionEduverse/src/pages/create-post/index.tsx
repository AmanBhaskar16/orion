    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 relative overflow-hidden">
      ...
      <main className="relative z-10 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-8">
        <div className="w-full">
                      ...
                      <div className="bg-gray-700/50 rounded-xl p-4 border border-gray-600/50 hover:border-purple-500/50 transition-all duration-300">
                        ...
                        {file.type === 'image' && (
                          <div className="mt-3 rounded-lg overflow-hidden">
                            <img src={file.url} alt="Preview" className="w-full h-32 object-cover" />
                          </div>
                        )}
                      </div>
                      <button
          ...
          {/* My Posts Section (abhi bhi localStorage se dikh raha hai, tu chahe to backend se bhi fetch kara sakte hain) */}
          <MyPostsSection />
        </div>
      </main>
    </div>
...
// My Posts Component (unchanged, abhi bhi localStorage se data dikhata hai)
